...
class TestBaseModel(unittest.TestCase):
    ...
    def test_init(self):
        ...
        # Check that the instance has a created_at attribute that is a datetime object
        self.assertIsInstance(base_model.created_at, datetime.datetime)
        # Check that the instance has an updated_at attribute that is a datetime object
    ...
    def test_to_dict(self):
        ...
        # Check that the dictionary has a __class__ key with the value 'BaseModel'
        self.assertEqual(base_model_dict['__class__'], 'BaseModel')
        # Check that the dictionary has an id key with the same value as the instance id
        self.assertEqual(base_model_dict['id'], base_model.id)
        # Check that the dictionary has a created_at key with the value of the instance created_at in ISO format
        self.assertEqual(base_model_dict['created_at'], base_model.created_at.isoformat())
        # Check that the dictionary has an updated_at key with the value of the instance updated_at in ISO format
